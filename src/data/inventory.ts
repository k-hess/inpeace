    ...
    items: [
      {
        ...
        whereToLookSelf: "You already know these — just list the banks by name. No need to write down balances or numbers, just which ones exist.",
      },
      {
        id: "money-cards",
        label: "Credit cards",
      ...
      },
      {
        ...
        whereToLookSelf: "If you have one, write down the bank and where the key actually lives — not just in a drawer only you know about.",
      },
      {
    ...
    items: [
      {
        ...
        whereToLookSelf: "The App Store or Google Play subscription list is the fastest way to see everything you're still paying for — worth a look even just for yourself.",
      },
      {
        id: "recurring-phone",
        label: "Phone plan",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        whereToLookSelf: "Note where your discharge paperwork is kept — and that a copy can always be requested from the National Archives if it's ever misplaced.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        whereToLookSelf: "If you've named an executor, make sure they actually know — and that it's written down somewhere your family would think to look.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        whereToLookSelf: "List your email accounts — the one you actually check day to day matters most.",
      },
      {
        ...
        whereToLookSelf: "Somewhere your family could find it — written down with your other important papers, not just in your head.",
      },
      {
      ...
      },
      {
        ...
        whereToLookSelf: "If anything pays you — ad revenue, royalties, rebates — write down where. Otherwise it just quietly stops showing up, unnoticed.",
        easilyMissed: true,
      },
    ],
  },
    ...
    items: [
      {
        ...
        whereToLookSelf: "You know the address — just make sure the deed or a recent utility bill is somewhere your family could confirm it too.",
