...
export const choosingGuides: ChoosingGuide[] = [
  {
    ...
    watchFor: [
      "\"Fee-based\" — it sounds like fee-only but includes commissions",
  ...
  },
  {
    ...
    lookFor: [
      ...
      "Clarity on who actually does the work — the attorney or a paralegal",
      "Someone who handles this county's probate court routinely",
    ],
    watchFor: ["An incentive to litigate rather than settle — conflict generates hours"],
    note: "Fee structures are state-specific. California sets a statutory fee schedule for probate attorney compensation based on the gross value of the estate — worth knowing it's a published schedule rather than a negotiation.",
  },
  {
