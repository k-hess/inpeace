...
export const liabilityCards: SimpleCard[] = [
  {
    ...
    copy: () => ({
      ...
      body: "Generally, debts are paid out of the estate before anything is distributed — relatives don't personally inherit debt simply by being related. The exceptions are what matter: you co-signed, you were a joint account holder, or state law puts a spouse on the hook. If any of those might apply to you, run it by an estate attorney before assuming either way.",
    }),
  },
  {
    ...
    copy: (ctx) => ({
      ...
      body:
        ctx.state === "TX"
          ? "Texas is a community-property state, which can change a surviving spouse's exposure to debts incurred during the marriage. The details depend on the specific debt and how it was structured — an estate attorney can tell you where you actually stand."
          : "California is a community-property state, which can change a surviving spouse's exposure to debts incurred during the marriage. The details depend on the specific debt and how it was structured — an estate attorney can tell you where you actually stand.",
    }),
  },
  {
    ...
    copy: () => ({
      ...
      body: "Federal student loans are generally discharged on death. Private loans vary, and a co-signer can still be on the hook — worth checking the terms of the specific loan, or asking an estate attorney if anything looks unclear.",
    }),
  },
  {
  ...
  },
  {
    ...
    copy: () => ({
      ...
      body: "There's an order in which debts get paid, and paying a low-priority creditor early out of your own pocket is a common and expensive mistake. It's fine to let bills sit unpaid for now while the bigger picture gets sorted — an estate attorney can tell you what actually needs to move first.",
    }),
  },
  {
